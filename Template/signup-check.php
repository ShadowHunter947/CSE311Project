...
if (isset($_POST['uname']) && isset($_POST['password'])
    && isset($_POST['FirstName']) && isset($_POST['LastName']) && isset($_POST['re_password'])) {
  ...
  $LastName = validate($_POST['LastName']);
    ...
    // hashing the password
		...
		if (mysqli_num_rows($result) > 0) {
           ...
           $sql2 = "INSERT INTO users(UserName, Password, FirstName, LastName) VALUES('$uname', '$pass', '$FirstName','$LastName')";
